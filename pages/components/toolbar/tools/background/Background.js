            ...
            >
              <ClickAwayListener onClickAway={handleClickAway}>
                <div className="modal-maximize transform transition-all ease-in-out duration-200 w-11/12 sm:w-10/12 md:w-8/12 lg:w-6/12 h-max rounded-2xl bg-zinc-100 dark:bg-zinc-700 text-zinc-800 dark:text-blue-200 m-2 fade-on-appear">
                  ...
                  <div className=" transform h-96 text-base sm:text-lg md:text-xl p-4 py-4 max-h-96 w-full text-zinc-600 dark:text-blue-200 transition-color duration-300 ease-in-out overflow-y-scroll flex flex-wrap justify-center gap-4">
                    {/* content */}
                    <Color
                      bgcolor="c1"
                      onClick={() =>
