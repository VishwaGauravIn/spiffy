    ...
    <>
      <div className="absolute bottom-0 w-full flex justify-center z-10 py-5">
        <div className="w-10/12 flex flex-wrap justify-center items-center gap-4">
          <button
            className="hidden transform p-4 sm:flex font-semibold text-lg justify-center items-center px-8 rounded-full bg-yellow-300 text-yellow-900 ease-in-out hover:bg-yellow-300/90 group outline-none ring ring-yellow-900 dark:ring-0"
          ...
          <div className="flex flex-wrap gap-4">
            <button className="sm:hidden transform p-3 flex flex-col font-semibold text-xs justify-center items-center rounded-full bg-yellow-300 text-yellow-900 ease-in-out duration-200 hover:bg-yellow-300/90 group outline-none active:scale-95 ring ring-yellow-900 dark:ring-0">
